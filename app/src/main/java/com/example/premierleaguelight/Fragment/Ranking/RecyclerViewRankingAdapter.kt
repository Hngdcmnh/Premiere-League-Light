...
class RecyclerViewRankingAdapter(var listTeam:List<Team>):RecyclerView.Adapter<RecyclerViewRankingAdapter.ViewHolder>() {
    lateinit var v:View
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerViewRankingAdapter.ViewHolder {
        v= LayoutInflater.from(parent.context).inflate(R.layout.item_ranking,parent,false)
        return RecyclerViewRankingAdapter.ViewHolder(v)
    }

    override fun onBindViewHolder(holder: RecyclerViewRankingAdapter.ViewHolder, position: Int) {
