...
object Model
{
    ...
    var results:ArrayList<Match> = ArrayList()
    ...
    fun getPoint()
    {
        ...
        for(team in listTeamW)
        {
            ...
            if(nameNextTeam!=name)
            {
                ...
                this.listMatch.add(Match(this.listTeam.find { it.name ==name },this.listTeam.find { it.name ==nameNextTeam },timeNextMatch,dayNextMatch,""))
//                Log.e(name, nameNextTeam)
    ...
    fun getTeam()
    {
        ...
        for(team in listTeamW)
        {
            ...
            this.listTeam.add(Team(name,flagUrl,"0",0,"","",""))
        }
    }
...
//            Log.e("Key", imgUrl)
            this.listNews.add(News(imgUrl.trim(),content,link))
        }
    }
}
